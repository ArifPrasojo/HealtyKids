  ...
  const menuItems = [
    {
      ...
      description: 'Kelola dan atur materi pembelajaran untuk siswa',
      icon: BookOpen,
      ...
      route: '/admin/managemateri'
    },
    {
      title: 'MANAJEMEN QUIZ',
      description: 'Buat dan kelola kuis untuk menguji pemahaman siswa',
      icon: Target,
    ...
    },
    {
      ...
      description: 'Kelola data siswa dan pengguna sistem',
      icon: Users,
