...
const MateriHome: React.FC<MateriHomeProps> = ({ onLogout }) => {
  ...
  return (
    <Layout onLogout={onLogout}>
      ...
      <button onClick={() => navigate('/dashboard')} className="fixed bottom-6 left-6 z-50 bg-white/80 backdrop-blur text-purple-700 px-4 py-2 rounded-full shadow-lg hover:bg-white transition-all flex items-center space-x-2 border border-purple-200">
        <span>⬅ Dashboard</span>
      </button>
